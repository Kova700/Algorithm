...
private fun main() {
    ...
    //가치가 1인 동전으로 i원을 만드는 경우의 수 == dp[i-1] == i-1원으로 만들 수 있는 경우의 수
    //가치가 2인 동전으로 i원을 만드는 경우의 수 == dp[i-2] == i-2원으로 만들 수 있는 경우의 수
    // ...
    //가치가 k인 동전으로 i원을 만드는 경우의 수 == dp[i-k] == i-k원으로 만들 수 있는 경우의 수
    //가치가 i인 동전으로 i원을 만드는 경우의 수 == dp[0] == 1
    //dp[i] =  위 경우의 수들의 총합
